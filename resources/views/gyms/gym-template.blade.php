                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        @php
                            $gym = Auth::user();
                        @endphp
                        <a href="/gym/profile" title="My Profile" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>{{ $gym->gname }}</a>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    {{-- <li>
                        <a href="#" class="waves-effect" id="member-link"><i class="fa fa-group fa-fw" aria-hidden="true"></i>Members <span id="dropdown-list"><i class="fa fa-sort-desc fa-fw" aria-hidden="true"></i> </span></a>
                    </li> --}}
                    
                        <li>
                            <a href="{{action('GymController@customers',$gid)}}" class="waves-effect"><i class="fa fa-group fa-fw" aria-hidden="true"></i>View Members</a>
                        </li>
                        <li>
                            <a href="/gym/addplan" class="waves-effect"><i class="fa fa-group fa-fw" aria-hidden="true"></i>Set Membership</a>
                        </li>
                    <li>
